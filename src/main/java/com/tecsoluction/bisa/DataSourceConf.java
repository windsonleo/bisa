...
//        dataSource.setUrl("jdbc:postgresql://localhost:5432/bisa");
...
//        dataSource.setPassword("");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        lcemfb.setPackagesToScan(new String[] {"com.tecsoluction.bisa.entidade"});

        lcemfb.setPersistenceUnitName("PU-BISA");
